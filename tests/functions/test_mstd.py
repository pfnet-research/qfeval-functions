...
def test_mstd_alternating_pattern() -> None:
    ...
    expected = torch.tensor([math.nan, expected_std, expected_std, expected_std, expected_std, expected_std])
...
def test_mstd_floating_point_precision() -> None:
    ...
    x = torch.tensor([1.0000001, 1.0000002, 1.0000003, 1.0000004], dtype=torch.float64)
...
def test_mstd_mixed_positive_negative() -> None:
    ...
    expected = torch.tensor([
        math.nan,
        math.nan,
        math.sqrt((((-5.0 - (-2.0))**2 + ((-2.0) - (-2.0))**2 + (1.0 - (-2.0))**2) / 2)),
        math.sqrt((((-2.0 - 1.0)**2 + (1.0 - 1.0)**2 + (4.0 - 1.0)**2) / 2)),
        math.sqrt(((1.0 - 4.0)**2 + (4.0 - 4.0)**2 + (7.0 - 4.0)**2) / 2)
    ])
